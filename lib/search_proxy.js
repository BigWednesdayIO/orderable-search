...
const getGroupAdjustmentsForProducts = (groupId, supplierId, date, ids) => {
  const uri = `${uris.suppliers}/suppliers/${supplierId}/price_adjustments?price_adjustment_group_id=${groupId}&date=${date.toISOString()}&product_id[]=${ids.join('&product_id[]=')}`;
